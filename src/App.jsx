...
function App() {
  ...
  useEffect(() => {
    ...
    Swal.fire(
      "Anh chị đợi 1 chút để server bật ạ!",
      "Server dùng render nếu quá 15 phút không có request sẽ tự động ngủ phải mất một số thời gian để bật lại"
    );
  }, [dispatch]);
    ...
    <div className="flex font-poppin overflow-y-auto min-h-screen relative">
      ...
      <Routes>
        <Route path={paths.PUBLIC} element={<Public />}>
          ...
          <Route
            path={paths.DETAIL_PRODUCT_CATEGORY_PID_TITLE}
