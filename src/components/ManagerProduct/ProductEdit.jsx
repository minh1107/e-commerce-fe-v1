...
const ProductEdit = ({dataProductEdit, onclick}) => {
  ...
  const handleCreateProduct = async (data) => {
    ...
    if (res.status) {
      ...
      reset();
    } else Swal.fire("Sửa thất bại", res.createProduct, "error");
  };

  return (
    <div className="w-[100vw] bg-[#cccccc75] h-[100vh] fixed top-0 left-0"> 
      <div className="m-20 bg-white z-50 w-[90%] h-[90%] rounded-xl p-4 shadow-xl">
        ...
        <Box className="">
          ...
          >
            <Box className="flex gap-4">
              <TextField
                defaultValue={dataProductEdit.title}
                className="w-3/5"
                label="Title product"
                variant="outlined"
              ...
              />
              <TextField
                defaultValue={dataProductEdit.price}
                className="w-1/5"
                label="Price"
                type="number"
                variant="outlined"
              ...
              />
              <TextField
                defaultValue={dataProductEdit.quantity}
                className="w-1/5"
                label="Quantity"
                type="number"
                variant="outlined"
            ...
            <Box className="flex gap-4">
              <FormControl variant="outlined" fullWidth margin="normal">
                ...
                <Select
                  defaultValue={dataProductEdit.category}
                  {...register("category")}
                  label="Category"
              ...
              <FormControl variant="outlined" fullWidth margin="normal">
                ...
                <Select defaultValue={dataProductEdit.brand} {...register("brand")} label="Brand">
              ...
              <FormControl variant="outlined" fullWidth margin="normal">
                ...
                <Select defaultValue={dataProductEdit?.color} {...register("color")} label="Color">
            ...
            <Box>
              <MarkDownEditor
                initialValue={dataProductEdit?.description.join("").toString()}
                name={"description"}
            ...
            <Box className="flex gap-4 w-full">
              <Button  size="large" variant="contained" type="submit">Edit product</Button>
